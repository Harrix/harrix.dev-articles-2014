...
В статье [Установка и настройка программ для редактирования LaTeX файлов](https://github.com/Harrix/harrix.dev-blog-2018/blob/main/2018-08-03-install-latex/2018-08-03-install-latex.md) прочитайте, если надо, про установку всех нужных программ для работы с LaTeX.
